    ...
    return (
        <div data-paper-header-frame data-paper-header>
            ...
            <div
                ...
                className="grid grid-cols-3"
            >
                <InlineField label="Name"    field="studentName" header={header} onChange={onChange} divider />
                <InlineField label="Roll No" field="rollNo"      header={header} onChange={onChange} divider />
                <InlineField label="Section" field="section"     header={header} onChange={onChange} />
            </div>

            {/* Row 3: Time | Date | Exam — equal thirds */}
            <div className="grid grid-cols-3">
                <InlineField label="Time" field="duration" header={header} onChange={onChange} divider />
                <InlineField label="Date" field="date"     header={header} onChange={onChange} divider />
                <InlineField label="Exam" field="type"     header={header} onChange={onChange} />
            </div>
        </div>
    );
}

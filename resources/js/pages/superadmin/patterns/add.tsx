        ...
        <>
            ...
            <div className="mx-auto max-w-2xl space-y-6 p-4 md:p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="h1-semibold">Add Pattern</h1>
                        <p className="text-muted-foreground text-sm">Create a new exam pattern</p>
                    </div>
                </div>
...
AddPattern.layout = {
    breadcrumbs: [
        ...
        { title: 'Add Pattern', href: '/superadmin/patterns/add' },
    ],
};

...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default function AddSubject({ patterns }: { patterns: PatternWithClasses[] }) {
            ...
            <div className="mx-auto max-w-2xl space-y-6 p-4 md:p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Create a new subject and link it to pattern–class combinations</p>
                    </div>
                </div>

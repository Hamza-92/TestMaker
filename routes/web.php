...
use App\Http\Controllers\Superadmin\ObjectiveLayoutController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('superadmin')->group(function () {
        ...
        Route::post('superadmin/patterns/reorder', [PatternController::class, 'reorder'])->name('superadmin.patterns.reorder')->middleware('permission:patterns.edit');
        ...
        Route::get('superadmin/paper-question-sections', [PaperQuestionSectionController::class, 'index'])->name('superadmin.paper-question-sections')->middleware('permission:question_types.view');
        Route::post('superadmin/paper-question-sections', [PaperQuestionSectionController::class, 'store'])->name('superadmin.paper-question-sections.store')->middleware('permission:question_types.edit');
